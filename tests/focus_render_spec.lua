...
assert_equal(FocusRender.opacityToGray(0), 0, "zero opacity is white")
assert_equal(FocusRender.opacityToGray(100), 1, "full opacity is black")
assert_equal(FocusRender.opacityToGray(150), 1, "opacity is clamped at one hundred")
